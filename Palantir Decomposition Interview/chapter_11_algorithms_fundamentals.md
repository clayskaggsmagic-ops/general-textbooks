# Chapter 11: Algorithms I — Complexity, Sorting, Searching, and Recursion
...
## 11.2 Algorithmic Complexity — The Language of Efficiency

### 11.2.1 What is Big O Notation?
...
### 11.2.2 The Complexity Classes — From Fast to Catastrophic
...
### 11.2.3 Big O, Big Theta, Big Omega — The Full Picture
...
### 11.2.4 Time vs. Space Complexity
...
### 11.2.5 Amortized Analysis — When Worst-Case Lies
...
### 11.3.1 Properties of Sorting Algorithms
...
### 11.3.3 Efficient Sorts — O(n log n)
...
### 11.3.4 The Efficient Sort Decision Table
...
### 11.3.5 Linear Sorts — Breaking the O(n log n) Barrier
...
### 11.3.6 The Grand Sorting Comparison Table
...
## 11.4 Searching Algorithms

### 11.4.1 Linear Search — The Brute Force Baseline
...
### 11.4.2 Binary Search — Divide and Conquer
...
### 11.4.3 Binary Search on Answer — The Power Technique
...
### 11.4.4 Interpolation Search — Smarter Guessing
...
### 11.4.5 Search Algorithm Summary
...
## 11.5 Recursion — Thinking in Self-Similarity
...
### 11.5.2 The Call Stack — What Actually Happens
...
### 11.5.3 Recursive vs. Iterative — The Trade-Off
...
### 11.5.4 Classic Recursive Problems
...
### 11.5.5 Memoization — The Bridge to Dynamic Programming
...
## 11.6 Connecting It All — Algorithms in SQL and Palantir
...
## 11.8 Chapter Summary — The "Cheat Sheet"

# Chapter 9: Data Structures I — Linear Structures and Hash Tables
...
## 9.2 Arrays and Dynamic Arrays

### 9.2.1 The Mental Model
...
### 9.2.3 Operations and Complexity
...
### 9.2.4 Dynamic Arrays — The Doubling Strategy
...
### 9.3.3 Operations and Complexity
...
### 9.3.4 When Linked Lists Beat Arrays
...
### 9.3.5 The LRU Cache — The Classic Combined Structure
...
## 9.4 Stacks — LIFO (Last In, First Out)

### 9.4.1 The Mental Model
...
## 9.5 Queues — FIFO (First In, First Out)

### 9.5.1 The Mental Model
...
### 9.6.4 Load Factor and Rehashing
...
### 9.7.3 Set Operation Complexity
...
## 9.8 The Grand Comparison Table
...
## 9.9 Choosing the Right Structure — Decision Flowchart
...
## 9.10 Common Interview Connections
...
## 9.12 Chapter Summary — The "Cheat Sheet"

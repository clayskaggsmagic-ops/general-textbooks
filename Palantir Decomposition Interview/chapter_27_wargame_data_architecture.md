# Chapter 27: The Data Architecture — How I Modeled and Stored Simulation Data

---

## 27.1 Why This Chapter Matters for Your Interview
...
## 27.2 The Central Data Model — TypedDicts as the Schema
...
### 27.2.1 SimulationState — The Root Object
...
### 27.2.2 AgentState — One Leader's Complete Profile
...
### 27.2.3 ActionRecord — What a Leader Did
...
### 27.2.4 MemoryEntry — The Unit of Memory
...
### 27.2.5 RoundSummary — The Immutable Round Record
...
### 27.2.6 The Complete Entity Hierarchy
...
## 27.2.7 The Data Validation Layer — LLM Output Contracts
...
## 27.3 The Reducer Pattern — How State Updates Work
...
### 27.3.1 How `merge_actions` Works
...
### 27.3.2 How `merge_memories` Works
...
### 27.3.4 The Complete Reducer Map
...
### 27.3.5 Why This Matters for Your Interview
...
## 27.4 The Database Schema — SQLite and Why
...
### 27.4.4 Schema Design Decisions and Trade-offs
...
### 27.4.5 Indexing Strategy — What Gets Indexed and Why
...
### 27.4.6 WAL Mode Internals — Why It Matters
...
### 27.4.7 The Production Migration Roadmap
...
### 27.4.8 Data Lineage and Provenance Tracking
...
## 27.5 Data Flow Through the System
...
## 27.6 The Agent Memory Data Flow — A Deep Dive
...
## 27.7 The RAG Analytics Pipeline — Data for Batch Analysis
...
### 27.7.4 Citation Parsing — The Hardest Part
...
## 27.8 Entity Relationship Summary
...
## 27.9 Connecting to Palantir Concepts
...
## 27.10 What I'd Do Differently (Self-Critique for Interviews)
...
## 27.11 Summary — Data Architecture Cheat Sheet

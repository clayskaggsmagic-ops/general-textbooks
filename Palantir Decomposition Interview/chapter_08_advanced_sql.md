# Chapter 8: Advanced SQL — Window Functions, Optimization, and Interview Patterns
...
## 8.2 Window Functions — The OVER() Clause

### 8.2.1 The Core Concept
...
### 8.4.4 Partition-Level Aggregates Without GROUP BY
...
## 8.5 Offset Functions — LAG, LEAD, FIRST_VALUE, LAST_VALUE, NTH_VALUE
...
### 8.5.2 FIRST_VALUE, LAST_VALUE, NTH_VALUE
...
## 8.6 Window Functions vs. GROUP BY — The Decision Framework
...
### 8.7.2 Composite (Multi-Column) Indexes
...
### 8.7.4 Partial (Filtered) Indexes
...
### 8.7.5 When to Index — and When NOT To
...
### 8.7.6 The Read/Write Trade-Off
...
## 8.8 Query Optimization — Reading EXPLAIN Plans

### 8.8.1 EXPLAIN vs. EXPLAIN ANALYZE
...
### 8.9.4 Pattern: Gap Analysis (Finding Missing Sequences)
...
### 8.9.6 Pattern: Pivot (Rows → Columns)
...
### 8.9.7 Pattern: Percent of Total
...
### 8.9.8 Pattern: Year-over-Year Comparison
...
### 8.10.1 The Big Five Anti-Patterns
...
### 8.10.2 Anti-Pattern Deep Dives
...
### 8.10.3 Quick Performance Checklist
...
## 8.11 Named Window Definitions (WINDOW Clause)
...
## 8.13 Chapter Summary — The "Cheat Sheet"

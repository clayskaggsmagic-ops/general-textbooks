# Chapter 7: SQL Fundamentals — The Core Query Language
...
## 7.2 Core Statement Structure

### 7.2.1 The SELECT Statement
...
### 7.2.3 The Execution Order Walkthrough
...
### 7.3.2 Visualizing Joins (Venn Diagram Model)
...
### 7.4.3 AVG and NULLs — The Classic Pitfall
...
### 7.4.4 GROUP BY with Multiple Columns
...
### 7.5.1 Four Types of Subqueries
...
### 7.5.2 Correlated vs. Uncorrelated
...
### 7.6.2 Why CTEs Over Subqueries?
...
### 7.6.4 CTE vs. Subquery vs. Temp Table
...
## 7.8 Filtering and Expressions

### 7.8.1 CASE Expressions
...
### 7.8.3 Other Filtering Operators
...
## 7.9 String, Date, and Numeric Functions

### 7.9.1 String Functions
...
## 7.10 Data Integrity Constraints
...
### 7.10.3 Referential Actions: CASCADE vs. RESTRICT
...
## 7.12 Putting It All Together — Practice Scenarios
...
## 7.14 Chapter Summary — The "Cheat Sheet"
